...
socket.on('connect_error', function(){
    ...
    app.socketConnected.msg = 'Tidak bisa koneksi ke server';
    app.chatLists = [];
});
            ...
            <div class="box box-primary direct-chat direct-chat-primary">
                ...
                <div style="display: block;" class="box-footer">
                    <div class="input-group">
                        <input name="message" v-bind:id="'msginput-' + cChat.id" v-model.trim="message" placeholder="Ketik pesan dan tekan enter" class="form-control" type="text" v-on:keydown="sendMessage($event)">
