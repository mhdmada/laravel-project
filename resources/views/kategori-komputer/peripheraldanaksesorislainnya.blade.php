          ...
          <div id="kontenkategori" class="col-md-2">
            ...
            <div class="col-md-10">
              <nav aria-label="breadcrumb" class="col-md-6">
                    <ol class="breadcrumb">
                      <li class="breadcrumb-item"><a href="#">Komputer & Aksesoris</a></li>
                      <li class="breadcrumb-item"><a href="#">Peripheral & Aksesoris</a></li>
                      <li class="breadcrumb-item active" aria-current="page">Peripheral & Aksesoris Lainnya</li>
                    </ol>
              </nav>
