          ...
          <div id="kontenkategori" class="col-md-2">
            ...
            <div class="col-md-10">
              <nav aria-label="breadcrumb" class="col-md-6">
                    <ol class="breadcrumb">
                      <li class="breadcrumb-item"><a href="#">Perlengkapan Ibu & Bayi</a></li>
                      <li class="breadcrumb-item"><a href="#">Perlengkapan Mandi Bayi</a></li>
                      <li class="breadcrumb-item active" aria-current="page">Handuk Dan Peralatan Mandi Bayi</li>
                    </ol>
              </nav>
                      ...
                      <div class="col-md-10  mb-4">
                         <div class="empty-icon-container">
                            ...
                            <div>
                              ...
                              <a href="{!! url('/'); !!}"><button class="btn btn-primary mt-4"><i data-feather="list"></i> Tampilkan semua produk</button></a>
                            </div>
