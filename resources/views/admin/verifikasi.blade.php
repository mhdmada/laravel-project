                    ...
                    <div class="tab-content custom-menu-content">
                        ...
                        <div id="Tables" class="tab-pane active notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                ...
                                <li><a href="{{ url('banned-user/') }}">Banned User</a>
                                </li>

                                <li><li><a data-toggle="modal" href="#ubahhari">Ubah Hari</a></li></li>
                            </ul>
                        </div>
                            ...
                            <table class="table table-sc-ex">
                                ...
                                @foreach($list_transaksi as $transaksi)
                                    <tr>
                                        ...
                                        <td>Rp.{{ $transaksi->biayakirim }}</td>
                                        <td>Rp.{{ $transaksi->asuransi }}</td>
                                        <td>Rp.{{ $transaksi->bantuan }}</td>
                                        <td>Rp.{{ $transaksi->subtotal }}</td>
