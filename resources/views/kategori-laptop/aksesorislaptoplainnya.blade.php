          ...
          <div id="kontenkategori" class="col-md-2">
            ...
            <div class="col-md-10">
              <nav aria-label="breadcrumb" class="col-md-6">
                    <ol class="breadcrumb">
                      <li class="breadcrumb-item"><a href="#">Laptop & Aksesoris</a></li>
                      <li class="breadcrumb-item"><a href="#">Aksesoris Laptop</a></li>
                      <li class="breadcrumb-item active" aria-current="page">Aksesoris Laptop Lainnya</li>
                    </ol>
              </nav>
