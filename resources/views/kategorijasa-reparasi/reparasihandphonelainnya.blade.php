        ...
        <div class="row">
          ...
          <div class="col-md-10">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Reparasi</a></li>
                    <li class="breadcrumb-item"><a href="#">Handphone</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Reparasi Handphone Lainnya</li>
                </ol>
              </nav>
              <div class="row">
                      @if(count($jasa) == 0)
