                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="tab-content custom-menu-content">
                        ...
                        <div id="Tables" class="tab-pane active notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                <li><a href="{{ url('admin/') }}">Rekening Information</a>
                                </li>
                                <li><a href="{{ url('verifikasi/') }}">Transaction Information</a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <table class="table table-sc-ex">
                                ...
                                @foreach($list_transaksi as $transaksi)
                                    <tr>
                                        ...
                                        <td>
                                            @if(!empty($transaksi->photo_transfer)) 
                                            <img width="100px;" class="img-thumbnail" src="uploads/{{ $transaksi->photo_transfer}}">
                                            @else
                                            Belum Ada Foto
                                            @endif
                                        </td>
                                        <td>
                                            @if($transaksi->verifikasi_transfer == 'true') 
                                            <h6><span class="badge badge-success"><i data-feather="check" style="width: 13px; height: 13px;"></i> Sudah Diverifikasi</span></h6>
                                            @else
                                             <h6><span class="badge badge-danger"><i data-feather="alert-octagon" style="width: 13px; height: 13px;"></i> Belum Diverifikasi</span></h6>
                                            @endif
                                        </td>

                                        <td class="text-center"><button class="btn btn-primary" data-toggle="modal" data-target="#verifikasi{{$transaksi->kode}}" > <span data-feather="clipboard"></span></button></td>
                                    </tr>
                                          ...
                                          <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                    Apakah Bukti Transfer sudah diverifikasi ?
                                                    <form method="POST" action="{{ route('verifikasi.update', $transaksi->kode ) }}">
                                                        @csrf
                                                        {{ method_field('put') }}
                                                      <input type="hidden" class="form-control" name="verifikasi_transfer" value="true" placeholder="Silahkan Masukkan Status">
                                              </div>
