...
<html lang="en">
  ...
  <body>
    ...
    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
      <h1 class="display-4">Supplier Premium</h1><br>
    ...
    <div class="container-fluid" style="padding-left: 250px; padding-right: 250px;">
      ...
      <div class="row">
        <div class="col-sm-3">
            <center><img src="user.png" alt="..." class="rounded-circle" width="150px" height="150px" ><br><br>
              <a href=""><p class="h4">Elon Musk</p></a>

            </center><br>
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
              <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">Home</a>
              <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">My Forum</a>
              <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false">My Product</a>
              <a class="nav-link" id="v-pills-cabang-tab" data-toggle="pill" href="#v-pills-cabang" role="tab" aria-controls="v-pills-cabang" aria-selected="false">Kantor Cabang</a>
            ...
            <div class="tab-content" id="v-pills-tabContent">
              ...
              <div class="tab-pane fade show active border-left" style="padding-left: 50px;" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                  <ul class="list-group list-group-flush">
                    <li class="list-group-item"><span data-feather="user"></span> Name: Elon Musk</li>
              ...
              <div class="tab-pane fade border-left" style="padding-left: 50px;" id="v-pills-cabang" role="tabpanel" aria-labelledby="v-pills-cabang-tab">
                        <h4 class="mb-3">Kantor Cabang</h4>
                        <form class="needs-validation" novalidate>
