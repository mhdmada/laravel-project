...
class KategoriPakaianPriaController extends Controller
{
  ...
  public function index(Request $request)
	 {
      ...
      if(Input::has('asal_produk')) {
          $query->where('asal_produk', Input::get('asal_produk'));
           echo "<script>console.log( 'asal produk sukses' );</script>";
      }


       if(Input::has('pembuatan_barang')) {
          $query->where('pembuatan_barang', Input::get('pembuatan_barang'));
            echo "<script>console.log( 'pembuatan barang sukses' );</script>";
      }
      ...
      if(Input::has('panjang_lengan')) {
          $query->where('panjang_lengan', Input::get('panjang_lengan'));
      }

      if(Input::has('bahan')) {
          $query->where('bahan', Input::get('bahan'));
      }
      ...
      $products = $query->where('kategori', 'LIKE', 'Busana Pria' )->WhereNull('deleted_at')->get();


      $categories = \App\Category::groupBy('kategori')->orderBy('kategori','asc')->get();
 
        return view('kategori-pakaianpria',compact('products','categories',
