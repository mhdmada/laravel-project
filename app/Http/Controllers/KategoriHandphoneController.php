...
class KategoriHandphoneController extends Controller
{
    ...
    $query = Product::query();
      ...
      $products = $query->where('kategori', 'LIKE', 'Handphone & Tablet' )->WhereNull('deleted_at')->get();


      $categories = \App\Category::groupBy('kategori')->orderBy('kategori','asc')->get();
 
        return view('kategori-handphone',compact('products','categories',
