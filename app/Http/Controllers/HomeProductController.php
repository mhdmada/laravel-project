...
class HomeProductController extends Controller
{
   ...
   public function index(Request $request)
    {
        $products = Product::all(); #menampilkan produk 
        ...
        return view('home-produk',compact('products','atasanpria','sepatupria','celanapria','outwearpria','jamtanganpria','taspria','batikpria','aksesorispria','pakaiandalampria','perhiasanpria'                              ,'bajutidurpria','atasanwanita','celanawanita','rok','dress','outwearwanita','batikwanita','pakaiandalamwanita','taswanita','sepatuwanita','                               jamtanganwanita','perhiasanwanita','aksesoriswanita','aksesorisrambut','perlengkapancouple','bajutidurwanita','perlengkapanjahit',
                                            'aksesorishandphone','aksesoristablet','memorycard','aksesorislaptop','harddisk','vgacard','printer','peripheral','networking','komponencomputer','optical',
                                            ...
                                            'gameconsole','cdgame','pcgaming','atasanmuslim','bawahanmuslim','dressmuslim','outwearmuslim','scarfmuslim','aksesorisjilbab','perlengkapanibadah',
    ...
    public function show($id)
    {
        ...
        $jumlah  =  Product::where('nama_supplier', $produk->nama_supplier)->count();

        $user = User::where('name', $produk->nama_supplier)->first();

        $tanggal = Product::whereDate('created_at', '=', date('d-m-Y'));

        return view('detail-product',compact('produk','jumlah','tanggal','komentar','user'));
    }
